...
export default function App() {
  ...
  const base =
    import.meta.env.MODE === "development"
      ? "/flashcards.json"
      : "https://cityofsmiles.github.io/factoring-difference-of-two-squares/flashcards.json";
  ...
  return (
    <div className="flashcards-container">
      <h1>Factoring the Difference of Two Squares</h1>
      ...
      <input
        ...
        placeholder="Type factored form, e.g. (x + 9)(x - 9)"
